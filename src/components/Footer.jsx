    ...
    <footer className="footer">
      <div className="footer-top">
        ...
        <div className="footer-cols">
          <div className="footer-col"><h4>Платформа</h4><a href="/#programs">Программы</a><a href="/#leaders">Лидерборд</a><a href="/#how">Как это работает</a><a href="#">Правила</a></div>
          ...
          <div className="footer-col"><h4>Исследователям</h4><Link to="/register">Регистрация</Link><a href="/#faq">FAQ</a><a href="#">Гайдлайн</a><a href="#">Блог</a></div>
